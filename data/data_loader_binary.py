...
class OLIVES_ds(Dataset):
    """This data loader return b-scans uniformly selected based on the stored indexes."""
...
class MS_ds(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # --- VLFAT STATISTICAL SHIFTING BLOCK ---
        ms_mean = 0.0107
        ms_std = 0.0535
        ...
        # Shift the MS image distribution to match the Duke pre-trained distribution
        imgs = (imgs - ms_mean) * (duke_std / ms_std) + duke_mean
        # ----------------------------------------
